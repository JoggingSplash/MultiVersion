...
class v361TypeConverter  {
	...
	public function __construct() {
		$this->converter = new MVTypeConverter(
			...
			$itemTypeDictionary = ItemTypeDictionaryFromDataHelper::loadFromString(Filesystem::fileGetContents(Path::join(Loader::getPluginResourcePath(), "v361", "required_item_list.json"))),
			new MVItemTranslator(
				...
				$blockItemIdMap,
				new MVItemIdMetaDowngrader($itemTypeDictionary, 14)
			),
