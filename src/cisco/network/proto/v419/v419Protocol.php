...
use cisco\network\proto\v419\packets\v419AnvilDamagePacket;
use cisco\network\proto\v419\packets\v419AvailableCommandsPacket;
use cisco\network\proto\v419\packets\v419BlockActorDataPacket;
use cisco\network\proto\v419\packets\v419BlockEventPacket;
...
use cisco\network\proto\v419\packets\v419SetSpawnPositionPacket;
...
final class v419Protocol extends TProtocol
{
	...
	public function outcoming(ClientboundPacket $packet) : ?ClientboundPacket
	{
		...
		return match (true) {
			$packet instanceof SetSpawnPositionPacket => v419SetSpawnPositionPacket::fromLatest($packet),
			$packet instanceof BlockEventPacket => v419BlockEventPacket::fromLatest($packet),
			$packet instanceof BlockActorDataPacket => v419BlockActorDataPacket::fromLatest($packet),
			$packet instanceof AnvilDamagePacket => v419AnvilDamagePacket::fromLatest($packet),
