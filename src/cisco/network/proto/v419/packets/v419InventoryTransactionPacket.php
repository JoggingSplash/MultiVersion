...
class v419InventoryTransactionPacket extends InventoryTransactionPacket
{
	...
	{
		$this->requestId = CommonTypes::readItemStackRequestId($in);
		...
		$hasItemStackId = CommonTypes::getBool($in);
	...
	protected function encodePayload(ByteBufferWriter $out) : void
	{
		...
		VarInt::writeSignedInt($out, $this->trData->getTypeId());

		ReflectionUtils::invoke(get_class($this->trData), $this->trData, "encodeData", $out);
	}
}
