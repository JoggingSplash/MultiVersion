...
use cisco\network\proto\v860\structure\v860CommonTypes;
...
class v860CommandRequestPacket extends CommandRequestPacket
{
	...
	protected function decodePayload(ByteBufferReader $in) : void
	{
		...
		$this->_originData = v860CommonTypes::getCommandOriginData($in);
	...
	protected function encodePayload(ByteBufferWriter $out) : void
	{
		...
		v860CommonTypes::putCommandOriginData($out, $this->_originData);
