...
class v486StartGamePacket extends StartGamePacket
{
	...
	public const NETWORK_ID = v486ProtocolInfo::START_GAME_PACKET;

	private array $itemTable = [];
	private v486LevelSettings $_levelSettings;
	private v486PlayerMovementSettings $_movementSettings;
	...
	public static function fromLatest(StartGamePacket $packet) : self
	{
		...
		$npk->_movementSettings = v486PlayerMovementSettings::fromLatest($packet->playerMovementSettings);
	...
	protected function decodePayload(ByteBufferReader $in) : void
	{
		...
		$this->_movementSettings = v486PlayerMovementSettings::read($in);
	...
	protected function encodePayload(ByteBufferWriter $out) : void
	{
		...
		$this->_movementSettings->write($out);
