...
class v486UpdateAttributesPacket extends UpdateAttributesPacket
{
	...
	public const NETWORK_ID = v486ProtocolInfo::UPDATE_ATTRIBUTES_PACKET;
	...
	protected function decodePayload(ByteBufferReader $in) : void
	{
		...
		$this->entries = v486CommonTypes::getAttributeList($in);
	...
	protected function encodePayload(ByteBufferWriter $out) : void
	{
		...
		v486CommonTypes::putAttributeList($out, ...$this->entries);
