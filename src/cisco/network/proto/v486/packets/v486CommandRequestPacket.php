...
class v486CommandRequestPacket extends CommandRequestPacket
{
	...
	public const NETWORK_ID = v486ProtocolInfo::COMMAND_REQUEST_PACKET;

	protected CommandOriginData $_originData;

	protected function encodePayload(ByteBufferWriter $out) : void {
		CommonTypes::putString($out, $this->command);
		v486CommonTypes::putCommandOriginData($out, $this->_originData);
	...
	protected function decodePayload(ByteBufferReader $in) : void
	{
		...
		$this->_originData = v486CommonTypes::getCommandOriginData($in);
