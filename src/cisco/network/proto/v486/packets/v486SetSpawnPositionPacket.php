...
class v486SetSpawnPositionPacket extends SetSpawnPositionPacket {

	static public function fromLatest(SetSpawnPositionPacket $packet) : self {
		$npk = new self();
		$npk->spawnType = $packet->spawnType;
		$npk->spawnPosition = $packet->spawnPosition;
		$npk->dimension = $packet->dimension;
		$npk->causingBlockPosition = $packet->causingBlockPosition;
		return $npk;
	}
